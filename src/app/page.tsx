    ...
    <div style={{ minHeight: '100vh', background: '#07060f', fontFamily: "'Apple SD Gothic Neo', sans-serif" }}>
      ...
      <style>{`
        @keyframes floatGlow {
          ...
          15%  {                                          opacity:.35; filter:drop-shadow(0 0 8px rgba(99,102,241,.55)) }
          45%  { transform:translateY(-18px) rotate(7deg); opacity:.55; filter:drop-shadow(0 0 14px rgba(99,102,241,.8)) }
          70%  {                                          opacity:.3;  filter:drop-shadow(0 0 6px rgba(99,102,241,.4)) }
          85%  {                                          opacity:0;   filter:drop-shadow(0 0 0px rgba(99,102,241,0)) }
      ...
      <script dangerouslySetInnerHTML={{ __html: `
        (function(){
          var foods=['🍜','☕','🍱','🍢','🍝','🍕','🍣','🧋','🥗','🥐','🍰','🍛','🌮','🍔','🍙','🧆'];
          var pos=[
            {top:'6%',left:'4%'},{top:'12%',right:'5%'},{top:'22%',left:'2%'},{top:'18%',left:'55%'},
            {top:'35%',right:'3%'},{top:'42%',left:'8%'},{top:'55%',right:'6%'},{top:'60%',left:'3%'},
            {top:'70%',left:'50%'},{top:'72%',right:'4%'},{top:'82%',left:'6%'},{top:'85%',right:'7%'},
            {top:'3%',left:'28%'},{top:'48%',left:'45%'},{top:'30%',left:'22%'},{top:'65%',left:'30%'},
          ];
          var c=document.getElementById('food-icons');
          if(!c)return;
          var icons=[];
          pos.forEach(function(p,i){
            var el=document.createElement('span');
            el.style.cssText='position:absolute;font-size:'+(18+Math.random()*14)+'px;line-height:1;opacity:0;animation:floatGlow '+(4.5+Math.random()*4).toFixed(1)+'s ease-in-out infinite;animation-delay:-'+(Math.random()*8).toFixed(1)+'s;';
